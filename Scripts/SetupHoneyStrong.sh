...
cd_protected() {
    ...
    declare -A PASSWORDS
    PASSWORDS["${BASE_DIR}/HR"]="Cyb3r_sec!"
    PASSWORDS["${BASE_DIR}/HR/Finance"]="Str0ngP4ss!"
    PASSWORDS["${BASE_DIR}/HR/Finance/Marketing"]="Bey-Bl4d3"
    PASSWORDS["${BASE_DIR}/HR/Finance/Marketing/IT"]="Really_C00l-Th1ng"
    PASSWORDS["${BASE_DIR}/HR/Finance/Marketing/IT/Sales"]="ABcdEF1!"
    PASSWORDS["${BASE_DIR}/HR/Finance/Marketing/IT/Sales/Admin"]="TheRing(!)"
